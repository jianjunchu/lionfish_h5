      ...
      goUse: function(t) {
        ...
        if (a.length >= i) {
            if (0 == a[i].is_limit_goods_buy) {
              ...
              var ids = e.split(",");
              s = 1 < ids.length ? "/ulink_comshop/pages/type/result?type=2&good_ids=" + e : "/ulink_comshop/pages/goods/goodsDetail?id=" + e,
                wx.navigateTo({
                  url: s
                });
            ...
            wx.navigateTo({
              url: "/ulink_comshop/pages/type/result?type=1&gid=" + o
            });
          }
        }
      },
