    ...
    <div class="pb100">
      ...
      <div :class="['fixed-vip',showTab?'hasVip':'']" v-if="is_open_vipcard_buy==1&&is_vip_card_member!=1">
        <div class="vip i-flex i-flex-spb">
          ...
          <div @click="goLink" data-link="/ulink_comshop/moduleA/vip/upgrade">立即开通
      ...
      <div :class="['fixed-bar',isIpx?'isIpx':'']" v-if="!isEmpty">
        <div class="fullreductionInfo" v-if="man_free_tuanzshipping>0&&delivery_tuanz_money>0&&tabIdx==0">
          ...
          <i-router-link :style="{color:skin.color}" url="/ulink_comshop/pages/index/index"
        ...
        <div class="fullreductionInfo" v-if="is_open_fullreduction==1&&reduceNum>0&&!isEmpty">
          ...
          <i-router-link url="/ulink_comshop/pages/index/index" v-if="disAmount<=0&&is_open_fullreduction==1">
          ...
          <i-router-link type="switch" url="/ulink_comshop/pages/index/index" v-else>
            <div class="i-link">
   ...
   /* mounted:function(){
    ...
    methods: {
      ...
      authSuccess: function() {
        const wx = this.$wx, app = this.$getApp()
        wx.reLaunch({
          url: '/ulink_comshop/pages/order/shopCart'
        })
      },
      authModal: function() {
          ...
          app.util.request({
            ...
            success: function(t) {
              if (0 == t.code) {
                var a = t.data || 0
                wx.navigateTo({
                  url: '/ulink_comshop/pages/order/placeOrder?type=dan&is_limit=' + a
                })
              } else {
