    ...
    <div class="groupCenter">
      ...
      <div class="distributionCon">
        <div class="distribution">
          ...
          <div class="incomeCon">
            ...
            <div @click="goLink" class="income" data-url="/ulink_comshop/pages/groupCenter/memberList">
      ...
      <div class="groupCenterCon">
        ...
        <div class="record">
          ...
          <!--<s hoverClass="none" href="#/ulink_comshop/pages/groupCenter/communityMembers" v-if="isShow">-->
            <!--<div class="recordList">-->
          ...
          <!--<a hoverClass="none" href="#/ulink_comshop/moduleA/solitaire/groupIndex" v-if="is_open_solitaire==1">-->
            <!--<div class="recordList">-->
          ...
          <a hoverClass="none" href="#/ulink_comshop/pages/groupCenter/distributionList">
            <div class="recordList">
          ...
          <a hoverClass="none" href="#/ulink_comshop/pages/groupCenter/wallet">
            <div class="recordList">
          ...
          <!--<a hoverClass="none" href="#/ulink_comshop/pages/groupCenter/list">-->
            <!--<div class="recordList">-->
          ...
          <!--<a hoverClass="none" href="#/ulink_comshop/pages/groupCenter/closure" v-if="open_community_addhexiaomember==1">-->
            <!--<div class="recordList">-->
          ...
          <a hoverClass="none" href="#/ulink_comshop/pages/groupCenter/gruopInfo" v-if="open_community_head_leve>0">
            <div class="recordList borNone">
...
//        });
      ...
      goOrder: function(t) {
        ...
        this.$wx.navigateTo({
          url: "/ulink_comshop/pages/groupCenter/groupList?tab=" + e
        });
      },
      goEdit: function() {
        this.$wx.navigateTo({
          url: "/ulink_comshop/pages/groupCenter/setting?id=" + this.data.community_info.id
        });
      },
