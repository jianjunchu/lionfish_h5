<template>
  <!--<div>-->
    ...
    <div class="apply-pass" v-if="member_info.is_head==2||apply_complete">
      ...
      <a class="link-btn" openType="switchTab" href="#/ulink_comshop/pages/index/index">{{$t('common.fanhuishouye')}}</a>
    </div>
    <!--</div>-->
      ...
      getUserInfo: function() {
        ...
        this.$http({
            ...
            if (0 == t.code) {
              ...
              1 == e.is_head && app.util.message("您已通过审核", "/ulink_comshop/pages/groupCenter/index", "error"),
                a.member_info= e;
            } else a.needAuth= !0;
