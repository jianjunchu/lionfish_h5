<template>
  ...
  <!-- <i-new-auth bind:authSuccess="authSuccess" bind:cancel="authModal" navBackUrl="/ulink_comshop/pages/type/index" needAuth="needAuth&&showAuthModal" needPosition="needPosition"></i-new-auth> -->
