  ...
  <div class="new-comers" v-if="list && list.length">
    ...
    <div ref="Box" @scroll="scrollEvent" class="new-comers-scroll">
      <div class="new-comers-wrap">
        <router-link class="new-comers-item" style="width: 25vw;margin-left: 3vw;margin-right: 3vw;" :to="'/ulink_comshop/pages/goods/goodsDetail?id='+item.actId"
          ...
          <div class="title" style="width: 25vw">{{item.spuName_en || item.spuName}}</div>
          <div class="new-bot">
...
<style src="@/ulink_comshop/components/new-comer/index.css">
