  ...
  export default {
    ...
    data() {
      return {
        ...
        tabbar: {
          ...
          list: [{
            pagePath: '/ulink_comshop/pages/index/index',
            text: '我的',
            iconPath: '',
            selectedIconPath: '',
            selected: !0
          }, {
            pagePath: '/ulink_comshop/pages/type/index',
            text: '我的',
            iconPath: '',
            selectedIconPath: '',
            selected: !1
            ...
            pagePath: '/ulink_comshop/pages/order/shopCart',
            text: '我的',
            iconPath: '',
            selectedIconPath: '',
            selected: !1
          }, {
            pagePath: '/ulink_comshop/pages/user/me',
            text: '我的',
            iconPath: '',
            selectedIconPath: '',
            selected: !1
    ...
    methods: {
      ...
      getTabbar() {
        ...
        this.$http({
          ...
          if (0 == response.code) {
            ...
            a.list[0].text = t.t1 || 'Home', a.list[0].iconPath = t.i1 || require('@/assets/images/icon-tab-index.png'),
              a.list[0].selectedIconPath = t.s1 || require('@/assets/images/icon-tab-index-active.png'),
              a.list[1].text = t.t4 || 'Category', a.list[1].iconPath = t.i4 || require('@/assets/images/icon-tab-type.png'),
              ...
              a.list[3].text = t.t2 || 'Cart', a.list[3].iconPath = t.i2 || require('@/assets/images/icon-tab-shop.png'),
              a.list[3].selectedIconPath = t.s2 || require('@/assets/images/icon-tab-shop-active.png'),
              a.list[4].text = t.t3 || 'Me', a.list[4].iconPath = t.i3 || require('@/assets/images/icon-tab-me.png'),
      ...
      goWeapp: function() {
        ...
        if (0 == a) {
          this.$wx.navigateTo({
            url: '/ulink_comshop/pages/web-view?url=' + encodeURIComponent(t)
          })
        } else if (1 == a) {
          -1 != ['/ulink_comshop/pages/index/index', '/ulink_comshop/pages/order/shopCart', '/ulink_comshop/pages/user/me', '/ulink_comshop/pages/type/index'].indexOf(t) ? this.$wx.switchTab({
            url: t
          }) : -1 != ['/ulink_comshop/moduleA/solitaire/index', '/ulink_comshop/moduleA/video/index', '/ulink_comshop/moduleA/menu/index', '/ulink_comshop/moduleA/pin/index'].indexOf(t) ? '/ulink_comshop/moduleA/solitaire/index' == t && this.needAut ? this.triggerEvent('authModal', !0) : this.$wx.redirectTo({
            url: t
          }) : this.$wx.navigateTo({
            url: t
          })
          ...
          this.$wx.navigateTo({
            url: '/ulink_comshop/moduleA/pin/index'
          })
        } else if (4 == a) {
          this.$wx.navigateTo({
            url: '/ulink_comshop/moduleA/menu/index'
          })
        } else if (5 == a) {
          this.$wx.navigateTo({
            url: '/ulink_comshop/moduleA/video/index'
          })
        } else if (6 == a) {
          if (this.needAuth) {
            ...
            this.$wx.navigateTo({
              url: '/ulink_comshop/moduleA/solitaire/index'
            })
          }
        } else if (7 == a) {
          this.$wx.navigateTo({
            url: '/ulink_comshop/moduleB/live/index'
          })
        }
      }
    }
