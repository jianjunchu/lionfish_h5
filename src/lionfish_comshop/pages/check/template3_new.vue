<template>
  ...
  <div class="goods-wrapper">
    ...
    <div class="wrapper" style="width: 88vw;height: 70vw;margin: 0 auto;text-align: center">
      <swiper :options="swiperOption" class="swiper-container">
        <swiper-slide v-for="(item,index) in goods_image2" :key="index">
          ...
          <img style="height: 70vw;max-width: 88vw"
                :src="item"/>
        </swiper-slide>
    ...
    <div v-if="verifyResult" :class="[showWord ? 'check-word-block': 'check-word-none']" id="clickDiv1" @click="turnShow">
        ...
        <div style="height: 2vw;width: 100%;margin-top: 0.03rem;position: relative;top: 0.7rem">
    ...
    <div v-if="verifyResult" style="margin: 2em auto;height: 15vw;text-align: center;width: 88vw;background: #fff;box-shadow: 0 2vw 3vw -1vw rgba(222,223,223,0.50);" >
			<table style="width: 88vw; height: 10vw; font-family: PingFangSC-Semibold;font-size: 15px;color: #717379;letter-spacing: 0;line-height: 10vw;margin: 0 auto;">
				<tr>
          <td id="oneDiv1"><div id="oneDiv" :class="[showOne? 'tab-style-block':'tab-style-none']" @click="turnOne">基本信息</div></td>
    ...
    <div v-if="verifyResult" id="oneDivView" :class="[showOne? 'one-div-block':'one-div-none']">
      <div style="width: 100%;height: 10vw;margin-top: 10px;border-bottom: 1px solid #000;">
				<div style="height: 100%;width: 40%;float: left;color: #000;font-weight: 600;text-align: left;">
					<span style="line-height: 8vw;font-size: 13px; letter-spacing: 0;">shopName</span>
				</div>
				<div style="height: 4vw;width: 60%;float: right;color: #000;font-weight: 600;text-align: right;display: table-cell;vertical-align:middle;margin-top: 1.6vw">
					<span style="font-size: 13px;letter-spacing: 0;vertical-align:middle;">{{shopName}}</span>
				</div>
			</div>
      <div style="width: 100%;height: 10vw;margin-top: 10px;border-bottom: 1px solid #000;">
				<div style="height: 100%;width: 40%;float: left;color: #000;font-weight: 600;text-align: left;">
					<span style="line-height: 8vw;font-size: 13px; letter-spacing: 0;">subtitle</span>
				</div>
				<div style="height: 4vw;width: 60%;float: right;color: #000;font-weight: 600;text-align: right;display: table-cell;vertical-align:middle;margin-top: 1.6vw">
					<span style="font-size: 13px;letter-spacing: 0;vertical-align:middle;" >{{subtitle}}</span>
				</div>
			</div>
      <div style="width: 100%;height: 10vw;margin-top: 10px;border-bottom: 1px solid #000;">
				<div style="height: 100%;width: 40%;float: left;color: #000;font-weight: 600;text-align: left;">
					<span style="line-height: 8vw;font-size: 13px; letter-spacing: 0;">goodname</span>
				</div>
				<div style="height: 4vw;width: 60%;float: right;color: #000;font-weight: 600;text-align: right;display: table-cell;vertical-align:middle;margin-top: 1.6vw">
					<span style="font-size: 13px;letter-spacing: 0;vertical-align:middle;" >{{goodname}}</span>
				</div>
			</div>

      <!-- 商品详情 -->
      <div style="text-align: center;line-height: 20px;height: 30vw" v-html="content">
