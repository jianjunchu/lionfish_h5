      ...
      <div class="special">
        ...
        <div class='like'>
          <div class='like-list' v-if="list.length">
            <router-link class="new-comers-item" :to="'/lionfish_comshop/pages/goods/goodsDetail?id='+item.actId" v-for="(item,index) in list" :key="item.actId">
  ...
  export default {
    ...
    methods: {
      ...
      onShow: function() {
        ...
        util.check_login_new().then(function(t) {
          t ? (that.needAuth = !1 , status.cartNum().then(t => {
            that.cartNum = t.data
          })) : (that.needAuth = !0,  that.navBackUrl = '/lionfish_comshop/pages/supply/home1?id=${id}')
        })
      },
      ...
      goSupplyRecruit: function() {
        wx.navigateTo({
          url: '/lionfish_comshop/pages/supply/recruit',
        })
      }
    }
  }
