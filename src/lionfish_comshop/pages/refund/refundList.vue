              ...
              <div class="i-card my-card" :data-orderId="item.order_id" showModal="true">
                ...
                <div class="card-footer" slot="footer">
                  ...
                  <div v-if="item.order_status_id==1||item.order_status_id==6||item.order_status_id==11||item.order_status_id==14">
                    <div bindtap="goOrder" class="my-button" :data-type="item.order_id" size="small">{{$t('order.chakanxiangqing')}}</div>
                  </div>
                </div>
              </div>
            </div>
            <i-load-more :loading="LoadingComplete[currentTab]" :tip="$t('order.meiyougengduodingdan')"></i-load-more>
          </div>
        </van-tab>
