...
var siteInfo = require('../../../siteinfo.js'), util = {}, app = getApp() || {
  siteInfo: siteInfo
}
...
function getQuery(e) {
  var t = []
  if (-1 != e.indexOf('?')) {
    for (var n = e.split('?')[1].split('&'), r = 0; r < n.length; r++) {
      n[r].split('=')[0] && unescape(n[r].split('=')[1]) && (t[r] = {
        name: n[r].split('=')[0],
...
function getSign(e, t, n) {
  ...
  for (var c = '', f = 0; f < i.length; f++) {
    i[f] && i[f].name && i[f].value && (c += i[f].name + '=' + i[f].value,
    f < i.length - 1 && (c += '&'))
  }
...
util.base64_encode = function(e) {
  ...
  e[2] && (n += 'do=' + e[2] + '&')), t && 'object' === (void 0 === t ? 'undefined' : _typeof(t))) {
  ...
  var n = wx.getStorageSync('userInfo').sessionid, a = r.url
  if (-1 == a.indexOf('http://') && -1 == a.indexOf('https://') && (a = util.url(a)),
  getUrlParam(a, 'state') || r.data && r.data.state || !n || (a = a + '&state=we7sid-' + n),
  !r.data || !r.data.m) {
  ...
  if (r.showLoading, r.cachetime) {
    var s = t(a), u = wx.getStorageSync(s), c = Date.parse(new Date())
    if (u && u.data) {
      if (u.expire > c) {
        return r.complete && 'function' == typeof r.complete && r.complete(u),
        r.success && 'function' == typeof r.success && r.success(u), console.log('cache:' + a),
          !0
      }
  ...
  wx.request((_defineProperty(e = {
    ...
    if (e.data.errno) {
      if ('41009' == e.data.errno) {
        return wx.setStorageSync('userInfo', ''), void util.getUserInfo(function() {
          util.request(r)
        })
      }
      if (r.fail && 'function' == typeof r.fail) {
        r.fail(e)
    ...
    var t = require('md5.js')(a), n = wx.getStorageSync(t)
    if (n && n.data) {
      return r.success && 'function' == typeof r.success && r.success(n),
  ...
  if ('object' == (void 0 === e ? 'undefined' : _typeof(e)) && (t = e.redirect, n = e.type,
    ...
    'navigate:' == a ? (o = 'navigateTo', i = t.substring(9)) : 'redirect:' == a ? (o = 'redirectTo',
      i = t.substring(9)) : 'switchTo:' == a ? (o = 'switchTab', i = t.substring(9)) : (i = t,
      o = 'redirectTo')
  }
  ...
  if (e) {
    var t = e.substring(0, 9), n = '', r = ''
    'navigate:' == t ? (r = 'navigateTo', n = e.substring(9)) : 'redirect:' == t ? (r = 'redirectTo',
      n = e.substring(9)) : 'switchTo:' == t ? (r = 'switchTab', n = e.substring(9)) : (n = e,
      r = 'redirectTo'), n && wx[r]({
      url: n
    })
  }
...
}, util.getLightColor = function(e, t) {
  e = e ? e.toUpperCase() : e
