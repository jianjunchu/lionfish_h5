export default {
  ...
  supply: {
    ...
    qingshuru: 'Please inpupt ',
    mingcheng: ' Name',
    chanpinyijiyoushi: 'Please write something about your products...',
    fahuodizhideyoubian: 'Postal Code Of your shop or warehouse',
    fahuodizhidedapaihao: 'Block',
    fahuodizhideluming: 'Street',
    fahuodizhidejianzhuming: 'Building',
    fahuodizhidemenpaihao: 'Unit',
    zhishurushuzi: '(Only Number)',
    qingshangchuan: 'Please Upload ',
    logotishi: 'Logo(Square)',
    bannertishi: 'Banner(Height: 300;Width: 700)',
    tijiaoshenqing: 'Submit',
