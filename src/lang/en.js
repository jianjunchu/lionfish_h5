export default {
  ...
  host: {
    ...
    shoujihao: 'Mobile',
    shurushoujihao: 'Please Input Your Mobile',
    youbian: 'Postal Code',
    shuruyoubian: 'Please Input Postal Code',
    dapai: 'Block No.',
    shurudapai: 'Please Input Block No.',
    luming: 'Street',
    shuruluming: 'Please Input Street',
    mengpaihao: 'Unit No.',
    shurumengpaihao: 'Please Input Unit No.',
  ...
  supply: {
    ...
    shenqingchengwei1tishi: ', please enter your real name and mobile',
    qingshuru: 'Please input ',
    mingcheng: ' Name',
    dianpumingchengtishi: 'Please input Store Name',
    lianxirentishi: 'Please input Name',
    shoujihaotishi: 'Please input Mobile',
    ...
    fahuodizhidedapaihaotishi: 'Please input Block',
    fahuodizhidelumingtishi: 'Please input Street',
    fahuodizhidejianzhumingtishi: 'Please input Building',
    fahuodizhidemenpaihaotishi: 'Please input Unit',
    qisongjinetishi: 'Please input amount for free delivery(Only Number)',
    yunfeitishi: 'Please input delivery fee for not reach the amount(Only Number)',
    logotishi: 'Please Upload Logo(Square)',
    bannertishi: 'Please Upload Banner(Height: 300;Width: 700)',
    tijiaoshenqing: 'Submit',
